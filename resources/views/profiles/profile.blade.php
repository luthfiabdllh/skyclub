...
<div x-data="{ activeTab: 'account', activeBookingTab: 'field' }">
    ...
    <div class="mt-8 pt-4 px-6 shadow bg-white rounded-lg">
        <div class="flex justify-evenly flex-wrap -mb-px text-sm font-semibold" role="tablist">
            <div class="text-center px-60 py-4" :class="{ 'text-red-600 border-b-4 border-black': activeTab === 'account' }">
                <button @click="activeTab = 'account'" class="inline-block">Account</button>
            </div>
            <div class="border-l border-gray-400 h-7 my-auto"></div>
            <div class="text-center px-60 py-4" :class="{ 'text-red-600 border-b-4 border-black': activeTab === 'history' }">
    ...
    <div x-show="activeTab === 'account'" class="mt-10">
        ...
        <div class="px-6 py-8 rounded-lg bg-gray-200 space-y-8">
            ...
            <div class="flex justify-between items-center">
                ...
                <a class="px-6 border-2 border-red-500 self-stretch items-center flex rounded-lg space-x-1 text" href="/">
    ...
    <div x-show="activeTab === 'history'" class="mt-10">
        ...
        <div class="mt-8 pt-4 px-6 shadow bg-white rounded-lg">
            <div class="flex justify-evenly flex-wrap -mb-px text-sm font-semibold" role="tablist">
                <div class="text-center p-40 py-4" :class="{ 'text-red-600 border-b-4 border-black': activeBookingTab === 'field' }">
                    <button @click="activeBookingTab = 'field'" class="inline-block">Lapangan</button>
                </div>
                <div class="border-l border-gray-400 h-7 my-auto"></div>
                <div class="text-center p-40 py-4" :class="{ 'text-red-600 border-b-4 border-black': activeBookingTab === 'sparing' }">
                    <button @click="activeBookingTab = 'sparing'" class="inline-block">Sparing</button>
                </div>
                <div class="border-l border-gray-400 h-7 my-auto"></div>
                <div class="text-center p-40 py-4" :class="{ 'text-red-600 border-b-4 border-black': activeBookingTab === 'finish' }">
