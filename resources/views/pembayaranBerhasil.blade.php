    ...
    <div class="my-10">
        <div class="border bg-white shadow p-5 rounded-xl px-[70px] py-[40px] mx-auto w-[765px]">
            ...
            <div class="flex items-stretch space-x-3">
                <a href="" class="bg-red-600 w-full text-center py-3 rounded-lg font-bold text-white">Cek Status Pembayaran</a>
                <a href="" class="bg-red-600 w-full text-center py-3 rounded-lg font-bold text-white">Pesan Lagi</a>
            </div>
        </div>
    </div>
