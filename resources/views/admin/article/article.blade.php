        ...
        @foreach ($articles as $article)
            ...
            <td>
                <div class="inline-flex rounded-md shadow-sm" role="group">
                    ...
                    <button data-modal-target="delete-modal" data-modal-toggle="delete-modal" type="button" class="px-4 py-2 text-sm font-medium text-white bg-red-500 rounded-e-lg hover:bg-red-600 focus:text-white dark:bg-red-700 dark:text-white dark:hover:bg-red-800 dark:focus:text-white">
                      Delete
                    </button>
