                                        ...
                                        <div id="confirmModal" tabindex="-1" aria-hidden="true"
                                            ...
                                            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                                ...
                                                <div
                                                    ...
                                                    <p class="mb-4 text-gray-500 dark:text-gray-300">Apakah anda yakin menerima pembatalan jadwal?</p>
                                                    <div class="flex justify-center items-center space-x-4">
                                                        <form
                                        ...
                                        <div id="confirmModal" tabindex="-1" aria-hidden="true"
                                            ...
                                            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                                ...
                                                <div
                                                    ...
                                                    <p class="mb-4 text-gray-500 dark:text-gray-300">Apakah anda yakin akan membatalkan pesanan?</p>
                                                    <div class="flex justify-center items-center space-x-4">
                                                        <form
