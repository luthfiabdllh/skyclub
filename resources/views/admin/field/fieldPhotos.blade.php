        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            @foreach ($fieldPhotos as $image)
                ...
                <div x-data="{ open: false, imageUrl: '' }">
                    ...
                    <div class="overflow-hidden rounded-lg border-gray-300 dark:border-gray-600 h-32 md:h-64 cursor-pointer"
                        @click="open = true; imageUrl = '{{ asset('storage/images/images/' . $image->photo) }}'">
