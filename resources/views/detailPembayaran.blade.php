            ...
            <div>
                ...
                <div class="space-y-1">
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-between border-s-8 border-red-600 bg-white p-2.5 font-bold text-base rounded-xl">
                            <p>14.00 - 16.00</p>
                            <p>Rp. 100.000,00</p>
                        </div>
                    </div>
                ...
                <div class="flex justify-between shadow bg-white rounded-lg items-center p-2.5 text-base">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <label for="default-radio-1" class="ms-2 font-medium text-gray-900 dark:text-gray-300 ">Rp. 5.000,00</label>
                    </div>
                </div>

            </div>
            <div class=" space-y-4">
                <button class="w-full py-3 border-2 border-red-600 text-center text-base rounded-xl font-bold text-red-600 flex items-center justify-center">
