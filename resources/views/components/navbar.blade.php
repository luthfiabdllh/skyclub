        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                <div class="flex items-baseline space-x-4">
                    <x-navlink href="/jadwalLapangan" :active="request()->is('jadwalLapangan')">Jadwal Lapangan</x-navlink>
                    <x-navlink href="/sparing" :active="request()->is('posts')">Sparing</x-navlink>
                    <x-navlink href="/artikel" :active="request()->is('about')">Artikel</x-navlink>
                </div>
            </div>
            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    <div class="flex items-baseline space-x-2">
                        @auth
                            <a href="#"
                                class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Selamat
