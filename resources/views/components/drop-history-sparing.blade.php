<div x-data="{ open: false, ratingSparingModal: false}" class="min-h-full bg-gray-200 shadow rounded-lg">
    ...
    <div x-show="ratingSparingModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
        <div class="bg-white p-6 rounded-lg">
            ...
            <div class="mt-4 flex justify-end">
                <button @click="ratingSparingModal = false" class="px-4 py-2 bg-gray-300 rounded-lg mr-2">Tutup</button>
