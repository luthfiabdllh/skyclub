        ...
        <ul class="space-y-2 pb-5 border-b border-gray-200 dark:border-gray-700">
            <li>
                <a href="{{ route('admin.index') }}"
                    ...
                    <svg aria-hidden="true"
                        class="w-6 h-6 fill-gray-500 transition duration-75 dark:fill-gray-500 group-hover:text-gray-900 dark:group-hover:text-white"
            ...
            <li>
                <button type="button"
                    ...
                    <svg class="flex-shrink-0 w-6 h-6 fill-gray-500 transition duration-75 group-hover:fill-gray-900 dark:text-gray-400 dark:group-hover:text-white"
            ...
            <li>
                <button type="button"
                    class="flex items-center p-2 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                    aria-controls="dropdown-voucher" data-collapse-toggle="dropdown-voucher">
                    <svg class="flex-shrink-0 w-6 h-6 fill-gray-500 transition duration-75 group-hover:fill-gray-900 dark:text-gray-400 dark:group-hover:text-white"
