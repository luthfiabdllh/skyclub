...
class NewRequestRescheduleNotification extends Notification
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'message' => 'Pesanan milik ' . $this->listBooking->booking->rentedBy->name . ' telah diajukan untuk ubah jadwal',
            'type' => 'Ubah Jadwal'
        ];
    }
}
